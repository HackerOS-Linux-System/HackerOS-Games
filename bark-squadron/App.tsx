...
import { Plane, Trophy, Skull, Rocket, Activity, Settings, X, Volume2, Gamepad2, Play, Gauge } from 'lucide-react';
...
export default function App() {
  ...
  return (
    ...
    {showSettings && (
      ...
      <span>Graphics: High Quality</span>
      <input
      type="checkbox"
      checked={settings.highQuality}
      onChange={(e) => setSettings(s => ({...s, highQuality: e.target.checked}))}
    ...
    {gameState === GameState.MENU && !showSettings && (
      ...
      <p className="text-slate-400 mb-8 font-mono text-sm">v0.6 // MODERN AIR COMBAT</p>
